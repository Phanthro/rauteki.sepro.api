...
namespace Rauteki.Sepro.Api.Misc.Extensions;
/// <summary>
...
public class SwaggerSmashBuckleOptions : IConfigureOptions<SwaggerGenOptions>
{
    ...
    private static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
    {
        ...
        {
            Title = "Rauteki/Sepro - API Service - Documentação",
            Version = description.ApiVersion.ToString(),
            Description 
                = "WebApi Para operações relacionadas  " +
                  "\n- **Autenticação/Login** \n",
            Contact = new OpenApiContact() { Name = "Rauteki/Serpro", Email = "	bruno.montenegro@rautakitecnologia.com.br" },       
        };
