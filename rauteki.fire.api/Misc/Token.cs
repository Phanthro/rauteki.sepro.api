...
public static class Token
{
    ...
    public static async Task<string> GetToken(IConfiguration configuration)
    {
        ...
        string key = configuration["Fire:APIPublicKey"]??throw new Exception("Nenhuma chave encontrada");
        string secret = configuration["Fire:APISecretKey"]??throw new Exception("Nenhum segredo encontrada");
